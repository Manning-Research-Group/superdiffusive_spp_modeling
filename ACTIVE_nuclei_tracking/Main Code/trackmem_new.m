% Kilfoil linking
% 
% Gao, Yongxiang, and Maria L. Kilfoil. "Accurate detection and complete 
%      tracking of large populations of features in three dimensions." 
%      Opt Express 17.6 (2009): 4685-4704.
%
% Pelletier, Vincent, et al. "Microrheology of microtubule solutions and
%      actin-microtubule composite networks." Physical review letters 
%      102.18 (2009): 188303.
%
...
function [lub] = trackmem_new(xyzs,maxdisp,dim,goodenough,memory)
tic
dd = length(xyzs(1,:));                
